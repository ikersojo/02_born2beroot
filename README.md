...
- Create folder in /sgoinfre/goinfre/Perso/**username** with the user name (e.g. sgoinfre/goinfre/Perso/isojo-go)
- Check folder permissions: 
$ ls -lap (they should be drwxr-xr-x)
- Change permissions to drwx------ by using the following command:
$ chmod 700 **username** (e.g. chmod 700 isojo-go)
- We can also create a direct link to the folder using the command:
$ ln -s /sgoinfre/goinfre/Perso/**username** ~/goinfre
...
NOTE: we can also create it in a
- Type: Linux
...
- Allocate 30GB of hard disk space
### Installation media
...
- Select hostname: **username**42 (e.g. isojo-go42)
- Leave the domain name blank.
- Introduce the root password. Write down this password for the evaluation!
- Create the first user, which is the **username**: first full name, then **username** and then password. Write everything down for evaluation!
- Select clock
